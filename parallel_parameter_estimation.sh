...
# produce data
# parallel poetry run python ./produce-data/produce-data.py ::: $read_data :::+ $model ::: $optical_delay # produce necessary data (perhaps not necessary)
# dry run (flag: --dry-run)
# parallel --dry-run poetry run python parameter_estimation.py ::: $read_data :::+ $model ::: $optical_delay
# run (useful flag: --progress)
# parallel --progress poetry run python parameter_estimation.py ::: $read_data :::+ $model ::: $optical_delay
